...
void GDT::Init() {
    ...
    */
    GDT::SetEntry(1, 0, 0xFFFFFFFF, 0x9A, 0xCF);
    ...
    */
    GDT::SetEntry(2, 0, 0xFFFFFFFF, 0x92, 0xCF);
    // User code and data segments, only differ in ring number(ring 3)
    GDT::SetEntry(3, 0, 0xFFFFFFFF, 0xFA, 0xCF);
    GDT::SetEntry(4, 0, 0xFFFFFFFF, 0xF2, 0xCF);
